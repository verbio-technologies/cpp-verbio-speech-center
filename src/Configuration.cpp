...
void Configuration::parse(int argc, char **argv) {
    ...
    options.set_width(180).allow_unrecognised_options().add_options()
            ...
            ("l,language", "Language to use for the recognition: es-ES, en-US or pt-BR.", cxxopts::value(language)->default_value(language))
            ...
            ("H,host", "URL of the Host or server trying to reach", cxxopts::value(host)->default_value(host))
